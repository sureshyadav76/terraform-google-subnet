...
```hcl
module "subnet" {
  source        = "git::https://github.com/sureshyadav76/terraform-google-subnet.git?ref=v1.0.0"
  name          = "app"
  environment   = "test"
...
## Examples
For detailed examples on how to use this module, please refer to the [Examples](https://github.com/sureshyadav76/terraform-google-subnet/tree/master/example) directory within this repository.
...
| <a name="input_repository"></a> [repository](#input\_repository) | Terraform current module repo | `string` | `"https://github.com/sureshyadav76/terraform-google-subnet"` | no |
